...
public class SteamMixer extends SteamMetaTileEntity {
    public SteamMixer(ResourceLocation metaTileEntityId,boolean isHighPressure) {
        super(metaTileEntityId, RecipeMaps.MIXER_RECIPES, GBTextures.STEAM_MIXER_OVERLAY, isHighPressure);
    }
    ...
    public ModularUI createUI(EntityPlayer player) {
        return createUITemplate(player)
                ...
                .widget(new TankWidget(this.importFluids.getTankAt(1), 18, 24, 18, 18)
                        .setBackgroundTexture(GBTextures.BRONZE_SLOT).setAlwaysShowFull(true).setContainerClicking(false, true))
